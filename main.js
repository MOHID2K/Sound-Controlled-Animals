function startClassification()
{
    ...
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/AnxQfgFlS/model.json', modelReady);
}
...
function gotResults(error, results)
{
    ...
    //Add the image and change the teachable machine link
}
